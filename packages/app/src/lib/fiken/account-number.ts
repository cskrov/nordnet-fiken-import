...
export const getLocalStorageAccountNumber = (referanse: string): string | null =>
  localStorage.getItem(getAccountNumberStorageKey(referanse));

export const setLocalStorageAccountNumber = (referanse: string, accountNumber: string): void =>
  localStorage.setItem(getAccountNumberStorageKey(referanse), accountNumber);
